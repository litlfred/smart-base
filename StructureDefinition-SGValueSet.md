# SMART Guidelines ValueSet - SMART Base v0.3.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/base/StructureDefinition/SGValueSet | *Version*:0.3.0 |
| Draft as of 2026-08-26 | *Computable Name*:SGValueSet |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/smart.who.int.base|current/StructureDefinition/StructureDefinition-SGValueSet.json)
