# Resource SGAuthoring.Skills.AuthorStructureMaps
...
{
  "resourceType" : "Basic",
  "id" : "SGAuthoring.Skills.AuthorStructureMaps",
  "meta" : {
  ...
  },
  {
    "extension" : [{
      ...
      "valueString" : "create FHIR StructureMaps for data extraction from QuestionnaireResponses"
    },
    {
      "url" : "http://smart.who.int/base/StructureDefinition/SGString",
      "valueString" : "questionnaire data is automatically extracted into structured FHIR resources"
    }],
  ...
  },
  {
    ...
    "valueUri" : "http://smart.who.int/base/Requirements/SGAuthoring.Skills.AuthorStructureMaps"
  },
  {
  ...
  },
  {
    ...
    "valueMarkdown" : "Capability to create FHIR StructureMaps for data extraction from QuestionnaireResponses to FHIR resources."
  },
  {
  ...
  },
  {
    ...
    },
    {
      ...
      "valueString" : "Create StructureMaps"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Can create FHIR StructureMaps for extracting data from QuestionnaireResponses into FHIR resources."
    }],
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "Can create StructureMaps mapping logical models to the International Patient Summary (IPS) data set."
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Validate extraction output"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "Can validate that StructureMap extraction produces exactly the expected output using reference tooling."
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  }],
  "code" : {
