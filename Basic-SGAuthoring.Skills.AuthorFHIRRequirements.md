# Resource SGAuthoring.Skills.AuthorFHIRRequirements
...
{
  "resourceType" : "Basic",
  "id" : "SGAuthoring.Skills.AuthorFHIRRequirements",
  "meta" : {
  ...
  },
  {
    "extension" : [{
      ...
      "valueString" : "create FHIR Requirements resources from L2 functional and non-functional requirements"
    },
    {
      "url" : "http://smart.who.int/base/StructureDefinition/SGString",
      "valueString" : "requirements are formally tracked as FHIR resources with traceability to actors and processes"
    }],
  ...
  },
  {
    ...
    "valueUri" : "http://smart.who.int/base/Requirements/SGAuthoring.Skills.AuthorFHIRRequirements"
  },
  {
  ...
  },
  {
    ...
    "valueString" : "SkillAuthorFHIRRequirements"
  },
  {
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
    "valueString" : "Can author FHIR requirements"
  },
  {
  ...
  },
  {
    ...
    "valueMarkdown" : "Capability to create FHIR Requirements resources from L2 functional and non-functional requirements."
  },
  {
  ...
  },
  {
    ...
    },
    {
      ...
      "valueString" : "Create Requirements resources"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Can create FHIR Requirements resources representing L2 functional and non-functional requirements."
    }],
  ...
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.label",
      "valueString" : "Define requirement statements"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.conformance",
      "valueCode" : "SHALL"
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "Can define requirement statements with key, label, conformance level, and requirement text."
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  },
  {
    ...
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement.requirement",
      "valueMarkdown" : "Can link Requirements resources to the appropriate ActorDefinitions."
    }],
    "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.statement"
  }],
  "code" : {
