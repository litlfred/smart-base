# Clinical Subject Matter Expert - SMART Base v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Clinical Subject Matter Expert**

## ActorDefinition: Clinical Subject Matter Expert (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/base/ActorDefinition/SGAuthoring.Persona.ClinicalSME | *Version*:0.2.0 |
| Draft as of 2026-03-23 | *Computable Name*:ClinicalSME |
